 ...
 * @date 2019/4/14
 */
public class ExportErrorDialog extends Dialog implements View.OnClickListener {
    ...
    public ExportErrorDialog(@NonNull Context context, String error, String path) {
        super(context);
    ...
    private void initView() {
        ...
        mTvTitle.setText(R.string.export_failed);
    }
