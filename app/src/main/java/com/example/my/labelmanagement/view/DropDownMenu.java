...
//        tab.setLayoutParams(new LayoutParams(0, ViewGroup.LayoutParams.WRAP_CONTENT, 1.0f));
    ...
    public void closeMenu() {
        if (current_tab_position != -1) {
            LinearLayout childAt = (LinearLayout) tabMenuView.getChildAt(current_tab_position);
            ((TextView) childAt.getChildAt(0)).setTextColor(textUnselectedColor);
            ((TextView) childAt.getChildAt(0)).setCompoundDrawablesWithIntrinsicBounds(null, null,
        ...
        for (int i = 0; i < tabMenuView.getChildCount(); i = i + 2) {
            if (target == tabMenuView.getChildAt(i)) {
                if (current_tab_position == i) {
                    ...
                    ((TextView) childAt.getChildAt(0)).setTextColor(textSelectedColor);
                    ((TextView) childAt.getChildAt(0)).setCompoundDrawablesWithIntrinsicBounds(null, null,
