...
public class PickerView extends View {
    ...
    private void initPaint() {
        ...
        mLightColor = ContextCompat.getColor(mContext, R.color.dark_gray);
        mDarkColor = ContextCompat.getColor(mContext, R.color.light_gray);
    }
