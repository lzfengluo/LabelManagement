    ...
    private void fillValue(int position, ViewHolder viewHolder) {
        ...
        if (checkItemPosition != -1) {
            if (checkItemPosition == position) {
                viewHolder.mText.setTextColor(context.getResources().getColor(R.color.tab_blue));
            } else {
                viewHolder.mText.setTextColor(context.getResources().getColor(R.color.light_gray));
            }
        }
    }
