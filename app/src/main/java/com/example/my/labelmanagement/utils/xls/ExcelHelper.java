...
public abstract class ExcelHelper<T> {
    ...
    private static ExcelHelper intance;


    public static ExcelHelper getInstance(File file) {
        synchronized (ExcelHelper.class) {

            if (file.getName().contains("xlsx")) {
                intance = XssfExcelHelper.getInstance(file);
            } else {
                intance = JxlExcelHelper.getInstance(file);
            }
     ...
     * @throws Exception
     */
    public List readExcel(Class clazz, int sheetNo, boolean hasTitle)
            throws Exception {
     ...
     * @throws Exception
     */
    public List readExcel(Class clazz, String[] fieldNames,
     ...
     * @throws Exception
     */
    public abstract List readExcel(Class<T> clazz, String[] fieldNames,
     ...
     * @throws Exception
     */
    public abstract void writeExcel(Class clazz, List dataModels,
     ...
     */
    protected boolean isDateType(Class clazz, String fieldName) {
        boolean flag = false;
        try {
